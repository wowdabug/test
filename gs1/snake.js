      ...
      cWz = function (a) {
        ...
        b
          ? (mSz(
              a.qb,
              a.settings.Ca === 1
                ? "assets/pixel/v17/px_count_03.png"
                : "assets/v17/count_03.png"
            ),
              ...
              for (const ia of c.children)
                if (ia.id !== "") {
                  ...
                  this.settings.Tb &&
                    ...
                    mSz(
                      ia.children[4],
                      "assets/halloween/default_jackolantern.png"
                    );
                  break;
                }
          this.oa = {
        ...
        if (this.menu.isVisible() || this.Eb.vj) {
          ...
          a.settings.Pa
            ? mSz(
                a.Ea,
                a.settings.Ca === 1
                  ? "assets/pixel/px_dc_trophy.png"
                  : "assets/dc_trophy.png"
              )
