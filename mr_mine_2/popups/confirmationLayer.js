class ConfirmationWindow extends PopupWindow
{
    ...
    createBody()
    {
        ...
        this.body.bodyContainer.render = function ()
        {
            ...
            var textAreaHeight = root.getTextAreaHeight();
            context.save();
    ...
    createButtons()
    {
        ...
        var buttonRegionCenterY = container.height * (0.5 + this.defaultTextAreaHeight / 2) - (container.height * this.buttonHeight) / 2
    ...
    getTextAreaHeight()
    {
        var textAreaHeight = this.defaultTextAreaHeight;
        if(isSimpleInputVisible())
        {
            var inputPosition = getSimpleInputPosition();
            var inputTop = inputPosition.top / mainh;
            var textTop = (this.body.boundingBox.y +
                this.body.bodyContainer.boundingBox.y +
                this.bodyPadding) / this.boundingBox.height;
            var globalTextAreaHeight = inputTop - textTop - this.bodyPadding;
            textAreaHeight = globalTextAreaHeight *
                this.boundingBox.height /
                this.body.bodyContainer.boundingBox.height;
        }
