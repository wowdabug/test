        ...
        this.drawConsumableHitbox = this.addHitbox(new Hitbox(
            ...
            },
            {
                onmousedown: function ()
                {
                    ...
                    {
                        showConfirmationPrompt(
                            _("Are you sure you want to use a Card Dispenser to draw {0} cards from the discard pile?<br>Excess cards will be returned to the deck", Math.min(battleManager.discardedWeps.length, battleManager.absoluteCardCap - battleManager.activeWeps.length)),
                            _("Yes"),
                            () =>
                            {
