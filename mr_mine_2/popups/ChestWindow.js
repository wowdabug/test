class ChestWindow extends TabbedPopupWindow
{
    ...
    constructor(boundingBox, chest)
    {
        ...
        else if(this.chest.type == ChestType.black)
        {
            this.spritesheet = blackChestSpritesheet;
        }
        else if(this.chest.type == ChestType.battle)
        {
            this.spritesheet = battleChestSpritesheet;
        }
        else
        {
    ...
    onChestClicked()
    {
        ...
        else
        {
            ...
            let instantChest = (this.chest.source == "instant") ? true : false;
            chestService.giveChestReward(this.chest, true, instantChest);
    ...
    close()
    {
        if((worlds[0].workersHired == 0 || this.chest.source == "instant") && !this.chestIsOpen)
        {
            this.onChestClicked()
        }
