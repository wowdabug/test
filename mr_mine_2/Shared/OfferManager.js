class OfferManager
{
    ...
    updateOffer(newOffer)
    {
        ...
        this.localizeOfferPrice(newOffer);
    ...
    async localizeOfferPrice(offer)
    {
            ...
            && (localizedPrices = await playsaurusSdk.localizePrices([(offer.price / 100).toFixed(2)], true)))
        {
            ...
            offer.localizedPriceFormatted = localizedPrices[0].localized._formatted;
            ...
            offer.formattedPrice = localizationResult.localized._formatted;
        }
        else
        {
    ...
    getOfferPriceCents()
    {
        ...
        {
            return this.currentOffer.localizedPrice;
        }
