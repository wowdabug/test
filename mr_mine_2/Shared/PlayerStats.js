...
var EQUIP_RECOVERY_CHANCE = new stat(11, "{0}% chance for an equip to be returned to your remaining cards after use", STAT_OPERATION_DECIMAL_ADD, 0.3);
var ENERGY_RECOVERY_CHANCE = new stat(12, "{0}% chance for an equip to cost 0 Energy", STAT_OPERATION_DECIMAL_ADD, 0.3);
var SCIENTIST_RESURRECTION_PERCENT_CHANCE = new stat(13, "Increases chance a scientist will immediately resurrect when killed by {0}%", STAT_OPERATION_INTEGER_ADD, 80);
var GEM_SPEED_MULTIPLIER = new stat(14, "Decrease gem crafting time by {0}%", STAT_OPERATION_DECIMAL_ADD, 0.75);
var BUILDING_MATERIAL_CHANCE_MULTIPLIER = new stat(15, "Increases the chance of finding building materials in basic chests by {0}%", STAT_OPERATION_DECIMAL_ADD);
var PERCENT_CHANCE_OF_SELLING_FOR_DOUBLE = new stat(16, "Increases chance of selling for 2x the price when selling minerals and isotopes by {0}%", STAT_OPERATION_INTEGER_ADD);
var ISOTOPE_DISCOVERY_CHANCE_MULTIPLIER = new stat(17, "Increases the chance of finding isotopes by {0}%", STAT_OPERATION_DECIMAL_ADD);
var CHEST_MONEY_MULTIPLIER = new stat(18, "Increases money from treasure chests by {0}%", STAT_OPERATION_DECIMAL_ADD);
var TIMELAPSE_DURATION_MULTIPLIER = new stat(19, "Increases all timelapse durations by {0}%", STAT_OPERATION_DECIMAL_ADD, 1);
var OIL_GENERATION_MULTIPLIER = new stat(20, "Increases the rate of oil generation by {0}%", STAT_OPERATION_DECIMAL_SUBTRACT, 0.8);
var MINER_UPGRADE_AND_HIRE_COST_MULTIPLIER = new stat(21, "Decreases miner upgrade and hire costs by {0}%", STAT_OPERATION_DECIMAL_SUBTRACT, 0.8);
var BUFF_DURATION_MULTIPLIER = new stat(22, "Increase the duration of buffs by {0}%", STAT_OPERATION_DECIMAL_ADD);
var CARGO_CAPACITY_MULTIPLIER = new stat(23, "Increases cargo capacity by {0}%", STAT_OPERATION_DECIMAL_ADD);
var BATTLE_CRIT_CHANCE_PERCENT = new stat(24, "Increase chance of a critical hit (2x damage) during battle by {0}%", STAT_OPERATION_INTEGER_ADD, 100);
var OFFLINE_PROGRESS_DURATION_MULTIPLIER = new stat(25, "Increases maximum duration of offline progress by {0}%", STAT_OPERATION_DECIMAL_ADD);
var MINERAL_DEPOSIT_CHANCE = new stat(26, "Increases Mineral Deposit spawn chance by {0}%", STAT_OPERATION_DECIMAL_ADD);
var ADDITIONAL_MINERAL_DEPOSITS = new stat(27, "Increases the maximum number of mineral deposits can be in the world by {0}", STAT_OPERATION_INTEGER_ADD);
var RELIC_MULTIPLIER = new stat(28, "Increases the effectiveness of your relics by {0}%", STAT_OPERATION_DECIMAL_ADD);

var DRONE_FUEL_REGEN_MULTIPLIER = new stat(29, "Increases the speed that caves regen fuel by {0}%", STAT_OPERATION_DECIMAL_ADD);
var DRONE_STARTING_FUEL_MULTIPLIER = new stat(30, "Increases drones starting fuel by {0}%", STAT_OPERATION_DECIMAL_ADD);
var DRONE_MOVEMENT_SPEED_MULTIPLIER = new stat(31, "Increases drones movement speed by {0}%", STAT_OPERATION_DECIMAL_ADD);
var SUPER_MINER_SPEED = new stat(32, "Increases super miner performance by {0}%", STAT_OPERATION_DECIMAL_ADD, 1);
var MINERAL_DEPOSIT_AMOUNT_MULTIPLIER = new stat(33, "Increases the maximum number of minerals from a mineral deposit by {0}%", STAT_OPERATION_DECIMAL_ADD);
var ETHEREAL_CHEST_SPAWN_FREQUENCY_MULTIPLIER = new stat(34, "Increases the current spawn rate of Ethereal chests by {0}%", STAT_OPERATION_DECIMAL_SUBTRACT, .85);
