...
function resetDepthForAscension()
{
    depth = 0;
...
class DrillState
{
    ...
    resetForAscension()
    {
        this.equippedDrillEquips = [1, 2, 3, 4];
        this.levelsTowardNextUpgrades = [0, 0, 0, 0];
        this.isDirty = true;

        for(var i = 4; i < this.equippedDrillEquips.length; i++)
        {
            this.equippedDrillEquips[i].isCrafted = false;
        }
    }
}
...
engine24.wattMultiplier = new BigNumber(4075000000);
...
drill24.level = 24;
drill24.baseWatts = new BigNumber(80000000000);
...
fan24.level = 24;
fan24.baseWatts = new BigNumber(150000000000);
...
engine26.wattMultiplier = new BigNumber(100000000000);
...
drill26.level = 26;
drill26.baseWatts = new BigNumber(1021000000000);
...
fan26.level = 26;
fan26.baseWatts = new BigNumber(1000000000000);
...
engine27.wattMultiplier = new BigNumber(500000000000);
...
drill27.level = 27;
drill27.baseWatts = new BigNumber(4363000000000);
...
fan27.level = 27;
fan27.baseWatts = new BigNumber(5525000000000);
...
engine28.wattMultiplier = new BigNumber(3000000000000);
...
drill28.level = 28;
drill28.baseWatts = new BigNumber(28000000000000);
...
fan28.level = 28;
fan28.baseWatts = new BigNumber(24500000000000);
...
engine30.wattMultiplier = new BigNumber(162000000000000);
...
drill30.level = 30;
drill30.baseWatts = new BigNumber(7510000000000000);
...
fan30.level = 30;
fan30.baseWatts = new BigNumber(7575000000000000);
...
engine31.wattMultiplier = new BigNumber(2050000000000000);
...
drill31.level = 31;
drill31.baseWatts = new BigNumber(55800000000000000);
...
fan31.level = 31;
fan31.baseWatts = new BigNumber(50500000000000000);
...
engine32.wattMultiplier = new BigNumber(19000000000000000);
...
drill32.level = 32;
drill32.baseWatts = new BigNumber(100000000000000000);
...
fan32.level = 32;
fan32.baseWatts = new BigNumber(120000000000000000);
...
engine33.level = 33;
engine33.baseWatts = new BigNumber(500);
engine33.wattMultiplier = new BigNumber(510000000000000000);
...
drill33.level = 33;
drill33.baseWatts = new BigNumber(450000000000000000);
...
fan33.level = 33;
fan33.baseWatts = new BigNumber(475000000000000000);
...
engine34.wattMultiplier = new BigNumber(1120000000000000000);
...
drill34.level = 34;
drill34.baseWatts = new BigNumber(950000000000000000);
...
fan34.level = 34;
fan34.baseWatts = new BigNumber(975000000000000000);
...
engine35.wattMultiplier = new BigNumber(3500000000000000000);
...
drill35.level = 35;
drill35.baseWatts = new BigNumber(2250000000000000000);
...
fan35.level = 35;
fan35.baseWatts = new BigNumber(3000000000000000000);
...
engine36.wattMultiplier = new BigNumber(35000000000000000000);
...
drill36.level = 36;
drill36.baseWatts = new BigNumber(32500000000000000000);
...
fan36.level = 36;
fan36.baseWatts = new BigNumber(30000000000000000000);
...
engine37.wattMultiplier = new BigNumber(280000000000000000000);
...
drill37.level = 37;
drill37.baseWatts = new BigNumber(260000000000000000000);
...
fan37.level = 37;
fan37.baseWatts = new BigNumber(250000000000000000000);
...
engine38.wattMultiplier = new BigNumber(2100000000000000000000);
...
drill38.level = 38;
drill38.baseWatts = new BigNumber(2100000000000000000000);
...
fan38.level = 38;
fan38.baseWatts = new BigNumber(2800000000000000000000);
...
engine39.wattMultiplier = new BigNumber(15000000000000000000000);
...
drill39.level = 39;
drill39.baseWatts = new BigNumber(20000000000000000000000);
...
fan39.level = 39;
fan39.baseWatts = new BigNumber(37000000000000000000000);
fan39.wattMultiplier = new BigNumber(1);
drillEquips.push(fan39);

var tempEngine = new DrillEquip(134);
tempEngine.translatedName = _("Nautical Engine") + " T4";
tempEngine.icon = icone35;
tempEngine.worldAsset = drilltop35;
tempEngine.type = ENGINE_TYPE;
tempEngine.level = 40;
tempEngine.baseWatts = new BigNumber(5000);
tempEngine.wattMultiplier = new BigNumber(60000000000000000000000);
drillEquips.push(tempEngine);

var tempDrill = new DrillEquip(135);
tempDrill.translatedName = _("Nautical Drill") + " T4";
tempDrill.icon = icond35;
tempDrill.worldAsset = drillbit35;
tempDrill.type = DRILL_TYPE;
tempDrill.level = 40;
tempDrill.baseWatts = new BigNumber(200000000000000000000000);
tempDrill.wattMultiplier = new BigNumber(1);
drillEquips.push(tempDrill);

var tempFan = new DrillEquip(136);
tempFan.translatedName = _("Nautical Heat Disperser") + " T4";
tempFan.icon = iconr35;
tempFan.type = DRILL_FAN_TYPE;
tempFan.level = 40;
tempFan.baseWatts = new BigNumber(200000000000000000000000);
tempFan.wattMultiplier = new BigNumber(1);
drillEquips.push(tempFan);

var tempEngine = new DrillEquip(137);
tempEngine.translatedName = _("Hydronaut Engine") + " T1";
tempEngine.icon = icone40;
tempEngine.worldAsset = drilltop40;
tempEngine.type = ENGINE_TYPE;
tempEngine.level = 41;
tempEngine.baseWatts = new BigNumber(5000);
tempEngine.wattMultiplier = new BigNumber(175000000000000000000000);
drillEquips.push(tempEngine);

var tempDrill = new DrillEquip(138);
tempDrill.translatedName = _("Hydronaut Drill") + " T1";
tempDrill.icon = icond40;
tempDrill.worldAsset = drillbit40;
tempDrill.type = DRILL_TYPE;
tempDrill.level = 41;
tempDrill.baseWatts = new BigNumber(500000000000000000000000);
tempDrill.wattMultiplier = new BigNumber(1);
drillEquips.push(tempDrill);

var tempFan = new DrillEquip(139);
tempFan.translatedName = _("Hydronaut Heat Disperser") + " T1";
tempFan.icon = iconr41;
tempFan.type = DRILL_FAN_TYPE;
tempFan.level = 41;
tempFan.baseWatts = new BigNumber(500000000000000000000000);
tempFan.wattMultiplier = new BigNumber(1);
drillEquips.push(tempFan);

var tempEngine = new DrillEquip(140);
tempEngine.translatedName = _("Hydronaut Engine") + " T2";
tempEngine.icon = icone41;
tempEngine.worldAsset = drilltop41;
tempEngine.type = ENGINE_TYPE;
tempEngine.level = 42;
tempEngine.baseWatts = new BigNumber(5000);
tempEngine.wattMultiplier = new BigNumber(370000000000000000000000);
drillEquips.push(tempEngine);

var tempDrill = new DrillEquip(141);
tempDrill.translatedName = _("Hydronaut Drill") + " T2";
tempDrill.icon = icond41;
tempDrill.worldAsset = drillbit41;
tempDrill.type = DRILL_TYPE;
tempDrill.level = 42;
tempDrill.baseWatts = new BigNumber(750000000000000000000000);
tempDrill.wattMultiplier = new BigNumber(1);
drillEquips.push(tempDrill);

var tempFan = new DrillEquip(142);
tempFan.translatedName = _("Hydronaut Heat Disperser") + " T2";
tempFan.icon = iconr42;
tempFan.type = DRILL_FAN_TYPE;
tempFan.level = 42;
tempFan.baseWatts = new BigNumber(750000000000000000000000);
tempFan.wattMultiplier = new BigNumber(1);
drillEquips.push(tempFan);

var tempEngine = new DrillEquip(143);
tempEngine.translatedName = _("Hydronaut Engine") + " T3";
tempEngine.icon = icone42;
tempEngine.worldAsset = drilltop42;
tempEngine.type = ENGINE_TYPE;
tempEngine.level = 43;
tempEngine.baseWatts = new BigNumber(5000);
tempEngine.wattMultiplier = new BigNumber(1220000000000000000000000);
drillEquips.push(tempEngine);

var tempDrill = new DrillEquip(144);
tempDrill.translatedName = _("Hydronaut Drill") + " T3";
tempDrill.icon = icond42;
tempDrill.worldAsset = drillbit42;
tempDrill.type = DRILL_TYPE;
tempDrill.level = 43;
tempDrill.baseWatts = new BigNumber(4500000000000000000000000);
tempDrill.wattMultiplier = new BigNumber(1);
drillEquips.push(tempDrill);

var tempFan = new DrillEquip(145);
tempFan.translatedName = _("Hydronaut Heat Disperser") + " T3";
tempFan.icon = iconr43;
tempFan.type = DRILL_FAN_TYPE;
tempFan.level = 43;
tempFan.baseWatts = new BigNumber(3000000000000000000000000);
tempFan.wattMultiplier = new BigNumber(1);
drillEquips.push(tempFan);

// var tempEngine = new DrillEquip(146);
// tempEngine.translatedName = _("Hydronaut Engine") + " T4";
// tempEngine.icon = icone38;
// tempEngine.worldAsset = drilltop38;
// tempEngine.type = ENGINE_TYPE;
// tempEngine.level = 44;
// tempEngine.baseWatts = new BigNumber(5000);
// tempEngine.wattMultiplier = new BigNumber(8640000000000000000000000);
// drillEquips.push(tempEngine);

// var tempDrill = new DrillEquip(147);
// tempDrill.translatedName = _("Hydronaut Drill") + " T4";
// tempDrill.icon = icond38;
// tempDrill.worldAsset = drillbit38;
// tempDrill.type = DRILL_TYPE;
// tempDrill.level = 44;
// tempDrill.baseWatts = new BigNumber(28000000000000000000000000);
// tempDrill.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempDrill);

// var tempFan = new DrillEquip(148);
// tempFan.translatedName = _("Hydronaut Heat Disperser") + " T4";
// tempFan.icon = iconr36;
// tempFan.type = DRILL_FAN_TYPE;
// tempFan.level = 44;
// tempFan.baseWatts = new BigNumber(24000000000000000000000000);
// tempFan.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempFan);

// var tempEngine = new DrillEquip(149);
// tempEngine.translatedName = _("Mariner Engine") + " T1";
// tempEngine.icon = icone39;
// tempEngine.worldAsset = drilltop39;
// tempEngine.type = ENGINE_TYPE;
// tempEngine.level = 44;
// tempEngine.baseWatts = new BigNumber(5000);
// tempEngine.wattMultiplier = new BigNumber(25920000000000000000000000);
// drillEquips.push(tempEngine);

// var tempDrill = new DrillEquip(150);
// tempDrill.translatedName = _("Mariner Drill") + " T1";
// tempDrill.icon = icond40;
// tempDrill.worldAsset = drillbit40;
// tempDrill.type = DRILL_TYPE;
// tempDrill.level = 44;
// tempDrill.baseWatts = new BigNumber(30240000000000000000000000);
// tempDrill.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempDrill);

// var tempFan = new DrillEquip(151);
// tempFan.translatedName = _("Mariner Heat Disperser") + " T1";
// tempFan.icon = iconr36;
// tempFan.type = DRILL_FAN_TYPE;
// tempFan.level = 44;
// tempFan.baseWatts = new BigNumber(34128000000000000000000000);
// tempFan.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempFan);

// var tempEngine = new DrillEquip(152);
// tempEngine.translatedName = _("Mariner Engine") + " T2";
// tempEngine.icon = icone41;
// tempEngine.worldAsset = drilltop41;
// tempEngine.type = ENGINE_TYPE;
// tempEngine.level = 45;
// tempEngine.baseWatts = new BigNumber(5000);
// tempEngine.wattMultiplier = new BigNumber(129600000000000000000000000);
// drillEquips.push(tempEngine);

// var tempDrill = new DrillEquip(153);
// tempDrill.translatedName = _("Mariner Drill") + " T2";
// tempDrill.icon = icond41;
// tempDrill.worldAsset = drillbit41;
// tempDrill.type = DRILL_TYPE;
// tempDrill.level = 45;
// tempDrill.baseWatts = new BigNumber(151200000000000000000000000);
// tempDrill.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempDrill);

// var tempFan = new DrillEquip(154);
// tempFan.translatedName = _("Mariner Heat Disperser") + " T2";
// tempFan.icon = iconr36;
// tempFan.type = DRILL_FAN_TYPE;
// tempFan.level = 45;
// tempFan.baseWatts = new BigNumber(170640000000000000000000000);
// tempFan.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempFan);

// var tempEngine = new DrillEquip(155);
// tempEngine.translatedName = _("Mariner Engine") + " T3";
// tempEngine.icon = icone42;
// tempEngine.worldAsset = drilltop42;
// tempEngine.type = ENGINE_TYPE;
// tempEngine.level = 46;
// tempEngine.baseWatts = new BigNumber(5000);
// tempEngine.wattMultiplier = new BigNumber(777600000000000000000000000);
// drillEquips.push(tempEngine);

// var tempDrill = new DrillEquip(156);
// tempDrill.translatedName = _("Mariner Drill") + " T3";
// tempDrill.icon = icond42;
// tempDrill.worldAsset = drillbit42;
// tempDrill.type = DRILL_TYPE;
// tempDrill.level = 46;
// tempDrill.baseWatts = new BigNumber(907200000000000000000000000);
// tempDrill.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempDrill);

// var tempFan = new DrillEquip(157);
// tempFan.translatedName = _("Mariner Heat Disperser") + " T3";
// tempFan.icon = iconr36;
// tempFan.type = DRILL_FAN_TYPE;
// tempFan.level = 46;
// tempFan.baseWatts = new BigNumber(1023840000000000000000000000);
// tempFan.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempFan);

// var tempEngine = new DrillEquip(158);
// tempEngine.translatedName = _("Mariner Engine") + " T4";
// tempEngine.icon = icone43;
// tempEngine.worldAsset = drilltop43;
// tempEngine.type = ENGINE_TYPE;
// tempEngine.level = 47;
// tempEngine.baseWatts = new BigNumber(5000);
// tempEngine.wattMultiplier = new BigNumber(4665600000000000000000000000);
// drillEquips.push(tempEngine);

// var tempDrill = new DrillEquip(159);
// tempDrill.translatedName = _("Mariner Drill") + " T4";
// tempDrill.icon = icond43;
// tempDrill.worldAsset = drillbit43;
// tempDrill.type = DRILL_TYPE;
// tempDrill.level = 47;
// tempDrill.baseWatts = new BigNumber(5443200000000000000000000000);
// tempDrill.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempDrill);

// var tempFan = new DrillEquip(160);
// tempFan.translatedName = _("Mariner Heat Disperser") + " T4";
// tempFan.icon = iconr36;
// tempFan.type = DRILL_FAN_TYPE;
// tempFan.level = 47;
// tempFan.baseWatts = new BigNumber(6143040000000000000000000000);
// tempFan.wattMultiplier = new BigNumber(1);
// drillEquips.push(tempFan);
...
function dig(dt)
{
    ...
    else
    {
        if(depth < (levels.length - 1) && !battleManager.isStalledDueToBoss())
        {
            ...
            if(cachedProgress !== undefined && cachedProgress.greaterThan(-1) && cachedDrillSpeedMultiplier == drillSpeedMultiplier && drillWattage() == cachedDigWattage && cachedProgressDepth == depth)
            {
...
{
    // ############################################################
    // ################ VALIDATE DRILL UPGRADE % ##################
    // ############################################################
    let logIncrease = true;

    let equips = drillEquips;
    let drills = [...equips].filter(e => e.type == DRILL_TYPE).sort((a, b) => a.level - b.level);
    let fans = [...equips].filter(e => e.type == DRILL_FAN_TYPE).sort((a, b) => a.level - b.level);;
    let engines = [...equips].filter(e => e.type == ENGINE_TYPE).sort((a, b) => a.level - b.level);;

    drills.forEach((drill, index) =>
    {
        let previous = drills[index - 1];
        if(previous == undefined) return;
        drill.baseWatts.multiply(drill.wattMultiplier).lessThan(previous.baseWatts.multiply(previous.wattMultiplier)) ? console.error(drill.translatedName + " has a lower wattage than " + previous.translatedName) : null;
        if(logIncrease) console.log(`${drill.translatedName} wattage increase: ${drill.baseWatts.multiply(drill.wattMultiplier).divide(previous.baseWatts.multiply(previous.wattMultiplier))}`);
    });

    fans.forEach((fan, index) =>
    {
        let previous = fans[index - 1];
        if(previous == undefined) return;
        fan.baseWatts.multiply(fan.wattMultiplier).lessThan(previous.baseWatts.multiply(previous.wattMultiplier)) ? console.error(fan.translatedName + " has a lower wattage than " + previous.translatedName) : null;
        if(logIncrease) console.log(`${fan.translatedName} wattage increase: ${fan.baseWatts.multiply(fan.wattMultiplier).divide(previous.baseWatts.multiply(previous.wattMultiplier))}`);
    });

    engines.forEach((engine, index) =>
    {
        let previous = engines[index - 1];
        if(previous == undefined) return;
        engine.wattMultiplier.lessThan(previous.wattMultiplier) ? console.error(engine.translatedName + " has a lower wattage than " + previous.translatedName) : null;
        if(logIncrease) console.log(`${engine.translatedName} wattage increase: ${engine.baseWatts.multiply(engine.wattMultiplier).divide(previous.baseWatts.multiply(previous.wattMultiplier))}`);
    });
