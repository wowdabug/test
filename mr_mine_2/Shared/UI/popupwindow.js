...
class TabbedPopupWindow extends PopupWindow
{
    ...
    initializeTabs(tabNames)
    {
        ...
        this.tabsContainer = new Hitbox(
            {
                ...
                height: this.boundingBox.width * 0.06
            },
            {}, "", "tabsContainer"
        );
        ...
        this.tabWidth = this.tabsContainer.boundingBox.width * 0.2;
        this.tabHeight = this.tabsContainer.boundingBox.height;
    ...
    createTabRenderFunction(parentElement, tabIndex, tabName)
    {
        ...
        return function ()
        {
            ...
            context.font = this.boundingBox.height * 0.5 + "px KanitM";
            fillTextShrinkToFit(
                context,
                tabName,
