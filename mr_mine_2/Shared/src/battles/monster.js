class monster
{
    ...
    grantReward()
    {
        if(this.isBoss)
        {
            ...
            newNews(_("You gained a {0} reward from defeating {1}!", battleChest.name, this.name));
        }
        ...
        if(this.reward)
        {
            ...
            newNews(_("You gained a {0} reward from defeating {1}!", this.reward.name, this.name));
        }
    }
