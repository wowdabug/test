translations["tchinese"] = () =>
{
    if(!translationsCache["tchinese"])
    {
        translationsCache["tchinese"] = {
            ...
            "Displays chest locations on scrollbar. Displays Gold chest expiration time.": "在滾軸上顯示箱子的位置。顯示金箱子的到期時間。",
            "Displays chests and gold chest locations on scrollbar. Displays Gold chest expiration time and location.": "在滾軸上顯示箱子和金箱子的位置。顯示金箱子的到期時間和位置。",
